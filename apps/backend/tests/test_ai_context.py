...
class TestAiContext:
    def test_create(self, client, auth_header, project_id):
        resp = client.post("/api/ai-context", json={
    ...
    def test_create_duplicate(self, client, auth_header, project_id):
        client.post("/api/ai-context", json={
            "project_id": project_id,
    ...
    def test_get_by_project(self, client, auth_header, project_id):
        ...
        resp = client.get(f"/api/ai-context/project/{project_id}", headers=auth_header)
    ...
    def test_update(self, client, auth_header, project_id):
        created = client.post("/api/ai-context", json={
            "project_id": project_id,
            "content": "Original",
        }, headers=auth_header).json()
        resp = client.patch(f"/api/ai-context/{created['id']}", json={
    ...
    def test_delete(self, client, auth_header, project_id):
        ...
        resp = client.delete(f"/api/ai-context/{created['id']}", headers=auth_header)
