<template>
  <div class="mx-auto max-w-md rounded-3xl border border-slate-800 bg-slate-900/90 p-8 shadow-xl shadow-slate-950/20">
    <h1 class="mb-6 text-3xl font-semibold text-white">Login</h1>
    <form @submit.prevent="submit" class="space-y-4">
      ...
      <button class="w-full rounded-2xl bg-brand-500 px-4 py-3 text-white hover:bg-brand-400">Sign in</button>
      <p class="text-sm text-slate-400">Don’t have an account? <NuxtLink to="/register" class="text-brand-300">Register</NuxtLink></p>
    </form>
  </div>
</template>
